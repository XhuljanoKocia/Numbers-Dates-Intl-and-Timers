...
// console.log(+'23'); //This is the same as converting a string to number
...
// // We can't place the underscore at the beginning, the end or right after the .
// const PI = 3.14_15;
// console.log(PI);
...
// console.log(new Date('Jan 14 2022 10:50:47'));
// console.log(new Date('December 24, 2015'));
// console.log(new Date(account1.movementsDates[0]));

// console.log(new Date(2037, 10, 19, 15, 23, 5)); // The months are 0 based
...
// console.log(Date.now()); //Gives a timestamp of the current moment
...
//   style: 'unit',
//   unit: 'mile-per-hour',
//   useGrouping: false, //The number is printed without separators
// };
